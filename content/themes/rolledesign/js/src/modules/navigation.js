...
(function ($) {
  ...
  (function () {
    ...
    menuToggle.on('click', function () {
      ...
      $('#nav-toggle-label').text(
        ...
        $('#nav-toggle-label').text() === rolle_screenReaderText.expand_toggle
          ? rolle_screenReaderText.collapse_toggle
          : rolle_screenReaderText.expand_toggle,
      );

      $(this).attr(
        'aria-label',
        $(this).attr('aria-label') === rolle_screenReaderText.expand_toggle
          ? rolle_screenReaderText.collapse_toggle
          : rolle_screenReaderText.expand_toggle,
      );
  ...
  $('.menu-item a, .dropdown button').on('keyup', function () {
    if ($('.dropdown').find(':focus').length !== 0) {
      ...
      if (event.keyCode === 27) {
        ...
        // jscs:enable
        screenReaderSpan.text(rolle_screenReaderText.expand);
    ...
    if (window.innerWidth > responsivenav) {
      ...
      screenReaderSpanPrev.text(rolle_screenReaderText.expand);
      ...
      screenReaderSpanNext.text(rolle_screenReaderText.expand);
    }
  });
  ...
  // TODO: Rather fix the issue: https://github.com/digitoimistodude/rolle/issues/26
  // $(() => {
  //   if (window.innerWidth < responsivenav) {
  ...
  //     dropdownItem.attr('aria-label', rolle_screenReaderText.collapse);
  //     screenReaderSpan.text(rolle_screenReaderText.collapse);
  //   }
  // });

  // Add default dropdown-toggle label
  $('.dropdown-toggle').each(function () {
    $(this).attr('aria-label', `${rolle_screenReaderText.expand_for} ${$(this).prev().text()}`);
  });
  ...
  siteHeaderMenu.find('.dropdown-toggle').click(function (e) {
    if (enterPressed || window.innerWidth < responsivenav) {
      ...
      $(this).attr(
        'aria-label',
        $(this).attr('aria-label') === `${rolle_screenReaderText.collapse_for} ${$(this).prev().text()}`
          ? `${rolle_screenReaderText.expand_for} ${$(this).prev().text()}`
          : `${rolle_screenReaderText.collapse_for} ${$(this).prev().text()}`,
      );
    }
  });
