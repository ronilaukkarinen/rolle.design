...
add_filter( 'air_helper_pll_register_strings', function() {
  ...
  /**
   * Uncomment if you need to have default rolle accessibility strings
...
function get_default_localization_strings( $language = 'en' ) {
  $strings = [
    'en'  => [
      'Add a menu'            => __( 'Add a menu', 'rolle' ),
      'Open main menu'        => __( 'Open main menu', 'rolle' ),
      'Close main menu'       => __( 'Close main menu', 'rolle' ),
      'Main navigation'       => __( 'Main navigation', 'rolle' ),
      'Back to top'           => __( 'Back to top', 'rolle' ),
      'Open child menu'       => __( 'Open child menu', 'rolle' ),
      'Open child menu for'   => __( 'Open child menu for', 'rolle' ),
      'Close child menu'      => __( 'Close child menu', 'rolle' ),
      'Close child menu for'  => __( 'Close child menu for', 'rolle' ),
      'Skip to content'       => __( 'Skip to content', 'rolle' ),
      'External site:'        => __( 'External site:', 'rolle' ),
      'opens in a new window' => __( 'opens in a new window', 'rolle' ),
      'Page not found.'       => __( 'Page not found.', 'rolle' ),
      'The reason might be mistyped or expired URL.' => __( 'The reason might be mistyped or expired URL.', 'rolle' ),
      'Search'                => __( 'Search', 'rolle' ),
    ],
    'fi'  => [
